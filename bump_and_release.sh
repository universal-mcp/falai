...
echo "Generating tools README for src/universal_mcp_falai/app.py..."
universal_mcp readme src/universal_mcp_falai/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_falai/README.md
